...
public class Solution {
    ...
    public static class Body {
        public static void calculateBMI(double weight, double height) {
            ...
            else if (BMI >= 18.5 && BMI < 25) System.out.println("Normal: 18.5 <= BMI < 25");
            else if(BMI >= 25 && BMI <30) System.out.println("Overweight: 25 <= BMI < 30");
            else System.out.println("Obese: BMI >= 30");
        }
    }
}
