...
public class Solution {
    ...
    public static class Ferrari extends LuxuryCar {
        public void printlnDesire() {
            /*Implement the printlnDesire method so that it displays "I want to drive a Ferrari".*/
    ...
    public static class GeoMetro extends CheapCar {
        public void printlnDesire() {
            //Implement the printlnDesire method so that it displays "I want to drive a Geo Metro".
    ...
    public static class LuxuryCar {
        protected void printlnDesire() {
            //Implement the printlnDesire method so that it displays "I want to drive a luxury car".
    ...
    public static class CheapCar {
        protected void printlnDesire() {
            //Implement the printlnDesire method so that it displays "I want to drive a cheap car".
